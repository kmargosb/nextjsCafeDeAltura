...
const NuevaFormCheckout = ({ onSubmit }) => {
  ...
  const handleRadioChange = (value) => {
    ...
    if (value === 'option1') {
      ...
      setValue('titular', 'disabled');
      setValue('numeroTarjeta', 'disabled');
      setValue('dateCard', 'disabled');
      setValue('CVC', 'disabled');
    }
  };
      ...
      <div className='p-2 flex flex-col gap-6 w-[792px]'>
        ...
        <div className='border-b-Taupe border-b pb-6'>
          <div className='flex gap-4 pb-6 items-center'>
            ...
            />
            <label htmlFor="tarjetaDebito" className='flex gap-4 w-full justify-between items-center'>
          ...
          <div className='w-[279px] flex flex-col gap-2 text-xs'>
            <div className='flex flex-col w-full gap-[3px]'>
              ...
              <input
                ...
                onChange={(e) => handleTextInputChange('titular', e.target.value)}
                {...register('titular', { required: radioOption === 'option1' })}
            ...
            <div className='flex flex-col w-full gap-[3px]'>
              ...
              <input
                ...
                className='flex w-full h-[36px] py-[10px] px-2 rounded-md border border-gray-300 hover:border-hover-inp focus:border-2 focus:outline-none focus:border-focus-inp'
                onChange={(e) => handleTextInputChange('numeroTarjeta', e.target.value)}
                {...register('numeroTarjeta', { required: radioOption === 'option1' })}
                disabled={radioOption !== 'option1'}
              />
            </div>
            <div className='flex w-full gap-6'>
              <div className='flex flex-col w-2/4 gap-[3px]'>
                ...
                <input
                  ...
                  placeholder='MM / YY'
                  className='flex w-full h-[36px] py-[10px] px-2 rounded-md border border-gray-300 hover:border-hover-inp focus:border-2 focus:outline-none focus:border-focus-inp'
                  onChange={(e) => handleTextInputChange('dateCard', e.target.value)}
                  {...register('dateCard', { required: radioOption === 'option1' })}
                  disabled={radioOption !== 'option1'}
                />
              </div>
              <div className='flex flex-col w-2/4 gap-[3px]'>
                ...
                <input type="text"
                  ...
                  placeholder='123'
                  className='flex w-full h-[36px] py-[10px] px-2 rounded-md border border-gray-300 hover:border-hover-inp focus:border-2 focus:outline-none focus:border-focus-inp'
                  onChange={(e) => handleTextInputChange('CVC', e.target.value)}
                  {...register('CVC', { required: radioOption === 'option1' })}
                  disabled={radioOption !== 'option1'}
                />
              </div>
            </div>
        ...
        <div className='border-b-Taupe border-b'>
          <div className='flex gap-4 pb-6 items-center'>
            <input
              ...
              {...register('radioOption')}
            />
            <label htmlFor="transferencia" className='flex gap-4 w-full justify-between items-center'>
              <div className='w-full flex flex-col gap-1'>
        ...
        <div>
          <div className='flex gap-4 items-center'>
            <input
              ...
              {...register('radioOption')}
            />
            <label htmlFor="bizum" className='flex gap-4 w-full items-center'>
...
export default NuevaFormCheckout